...
const EVENTS = new Set(["started", "question_1", "question_2", "question_3", "question_4", "question_5", "question_6", "reviewed", "email_gate", "submitted", "completed", "failed"]);
...
export default async function handler(req, res) {
  ...
  try {
    await recordAnalyticsEvent(sessionId, event);
